...
<template>
  <div ref="containerRef" class="relative">
    ...
    >
      <section
        v-if="isOpen"
        class="absolute right-0 z-50 mt-3 w-[min(24rem,calc(100vw-2rem))] overflow-hidden rounded-[1.8rem] border border-border/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(247,243,252,0.96))] p-4 shadow-[0_30px_60px_rgba(18,12,32,0.18)] backdrop-blur dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(21,18,33,0.98),rgba(28,24,42,0.96))]"
        role="dialog"
