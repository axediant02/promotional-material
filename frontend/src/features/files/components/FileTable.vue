...
<template>
  <section class="pm-surface rounded-[1.8rem] p-6 lg:p-8">
    <div class="mb-6">
      <h2 class="text-2xl font-semibold tracking-[-0.03em] text-ink dark:text-white [font-family:'Iowan_Old_Style','Palatino_Linotype','Book_Antiqua',Palatino,serif]">Recent files</h2>
