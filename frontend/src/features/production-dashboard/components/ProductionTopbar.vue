...
<template>
  <header class="border-b border-border/70 bg-white/35 px-6 py-5 backdrop-blur-sm dark:border-white/10 dark:bg-white/[0.02] sm:px-8 lg:px-10">
    <div class="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
      ...
      <div class="flex w-full max-w-2xl flex-col gap-3 lg:items-end">
        <div class="flex w-full items-center gap-3">
          <div class="relative flex-1">
            ...
            <input
              :value="searchQuery"
              type="text"
              placeholder="Search folders, clients, files, or requests"
              class="pm-input h-12 w-full rounded-2xl border-border/90 bg-white/80 py-3 pl-11 pr-4 text-sm shadow-[var(--shadow-xs)] placeholder:text-muted dark:border-white/10 dark:bg-white/[0.06] dark:placeholder:text-zinc-500"
          ...
          />
          <button
            class="flex h-12 w-12 items-center justify-center rounded-2xl border border-border/80 bg-white/70 text-muted transition hover:border-brand-500 hover:text-brand-700 hover:shadow-[var(--shadow-xs)] dark:border-white/10 dark:bg-white/5 dark:text-white dark:hover:border-white/20 dark:hover:text-white"
            type="button"
